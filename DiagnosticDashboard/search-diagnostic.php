...
<body>
    ...
    <div class="my-container active-cont d-flex flex-column justify-content-start vh-100">
        ...
        <div class="container">
            <div class="row d-flex align-items-center justify-content-between my-3 mx-2">
                <div class="col-2 h4 text-ems-green">Tests</div>
                ...
                <div class="col-7 col-md-4 form-outline">
                    <input type="search" class="form-control" id="searchDiagTest" placeholder="Search..">
                </div>
            </div>
    ...
    <script>
        ...
        $(document).ready(function () {
            $('#list').click(function (event) { event.preventDefault(); $('#diagnostics .item').addClass('list-group-item'); });
            $('#grid').click(function (event) { event.preventDefault(); $('#diagnostics .item').removeClass('list-group-item'); $('#doctors .item').addClass('grid-group-item'); });
        });
    </script>
    <!-- JS SCRIPT END -->
</body>

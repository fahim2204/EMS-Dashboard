                ...
                <div class="row p-3 bg-light rounded-2 m-2 mt-4 shadow-sm">
                    <div class="col-12 col-md-4 mt-2">
                        <div class="mb-3">
                            ...
                            <input type="text" disabled class="form-control" id="emsId" value="DR-2022123"
                    ...
                    <div class="col-12 col-md-4 mt-2">
                        ...
                        <!-- <div class="mb-3">
                            ...
                            <select id="profession" class="form-select" aria-label="Gender Select">
                        ...
                        <div class="mb-3">
                            <label for="Address" class="form-label">Your Address Line 1</label>
                            <input type="text" class="form-control" id="Address"
                                value="H-30, B-12, South Banasree, Dhaka"
                                placeholder="E.g. H-30, B-12, South Banasree, Dhaka" />
                        </div>
                        <div class="mb-3">
                            <label for="Address" class="form-label">Your Address Line 2</label>
                            <input type="text" class="form-control" id="Address"
                                value="H-30, B-12, South Banasree, Dhaka"
                                placeholder="E.g. H-30, B-12, South Banasree, Dhaka" />
                        </div>
                        <div class="mb-3">
                            ...
                            <div class="mt-1">
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="isSupportPeople" id="inlineRadio1"
                                        value="option1" />
                                    <label class="form-check-label" for="inlineRadio1">Yes</label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="isSupportPeople" id="inlineRadio2"
                    ...
                    <div class="col-12 col-md-4 mt-2">
                        ...
                        <div class="mb-3">
                            <label for="bmdc" class="form-label">Your BMDC Number</label>
                            <input type="bmdc" class="form-control" id="bmdc" value=""
                                placeholder="E.g. 13435" />
                        </div>
                        <div class="mb-3">
                            <label for="speciality" class="form-label">Your Speciatiality</label>
                            <input type="text" class="form-control" id="speciality"
                                value=""
                                placeholder="E.g. Neorologist" />
                        </div>
                        <div class="mb-3">

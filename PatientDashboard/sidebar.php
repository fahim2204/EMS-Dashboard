<div class="side-navbar active-nav d-flex flex-column shadow-sm" id="sidebar">
    ...
    <ul class="nav flex-column text-white w-100 cursor-pointer mt-2">
        ...
        <a href="update-details.php" class="nav-link <?php if($page=='updetails'){echo 'active';}?>">
        ...
        <a href="family-members-list.php" class="nav-link <?php if($page=='memberdetails'){echo 'active';}?>">
            <i class="bx bxs-user-account"></i>
            <span class="mx-2">Member Details</span>
        </a>
        <a href="reward-point.php" class="nav-link <?php if($page=='rewardpoint'){echo 'active';}?>">
            <i class="bx bx-wallet"></i>
            <span class="mx-2">Reward Points</span>
        </a>
        <a href="prescription.php" class="nav-link <?php if($page=='prescription'){echo 'active';}?>">
        ...
        <a href="medical-report.php" class="nav-link <?php if($page=='medicalreport'){echo 'active';}?>">
            <i class='bx bxs-report'></i>
            <span class="mx-2">Your Medical Reports</span>
        </a>
        <a href="medical-history.php" class="nav-link <?php if($page=='medicalhistory'){echo 'active';}?> ">
            <i class='bx bx-history'></i>
            <span class="mx-2">Your Medical History</span>
        </a>
        <a href="medicaldetails.php" class="nav-link <?php if($page=='medicaldetails'){echo 'active';}?>">
            <i class='bx bx-history'></i>

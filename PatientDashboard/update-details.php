        ...
        <div class="container">
            ...
            <ul class="nav nav-pills mt-3 mb-3 d-flex justify-content-center">
                ...
                <li class="nav-item p-3">
                    <a class="nav-link active" data-bs-toggle="pill" href="#pdetail">Personal Details</a>
                </li>


                <li class="nav-item p-3">
                    <a class="nav-link" data-bs-toggle="pill" href="#mdetail">Medical Details</a>
                </li>
            ...
            <div class="tab-content">
                <div class="tab-pane container bg-light active" id="pdetail">
                    <form action="#" method="post">
                        <div class="row p-3 bg-light rounded-2 m-2 mt-4 shadow-sm text-black">
                            <div class="col-12 col-md-4 mt-2">
                                <div class="mb-3">
                                    <label for="emsId" class="form-label">EMS ID</label>
                                    <input type="text" disabled class="form-control" id="emsId" value="PT-2022123" placeholder="E.g. PT-XXXXX" />
                ...
                <div class="tab-pane container bg-light fade" id="mdetail">
                    <form action="#" method="post">
                        <div class="row p-3 bg-light rounded-2 m-2 mt-4 shadow-sm text-black">
                            <div class="col-12 col-md-4 mt-2">
                                <div class="mb-3">
                ...
                <div class="tab-pane container bg-light fade" id="other">
                    <form action="#" method="post">
                        <div class="row p-3 bg-light rounded-2 m-2 mt-4 shadow-sm text-black">
                            <div class="col-12 col-md-4 mt-2">
                                <div class="mb-3">
